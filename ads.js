...
window.ToolsDB = {
  defaults: [
    ...
    {id:2,name:'ChatGPT',emoji:'💬',cat:'chat',pricing:'freemium',tagline:"OpenAI's conversational AI for writing, coding, analysis and more.",votes:5230,featured:true,url:'https://chatgpt.com',daysAgo:180,approved:true,image:'https://icons.duckduckgo.com/ip3/openai.com.ico'},
    ...
    {id:4,name:'Claude',emoji:'🤖',cat:'chat',pricing:'freemium',tagline:"Anthropic's AI assistant for analysis, writing and reasoning.",votes:1654,featured:false,url:'https://claude.ai',daysAgo:90,approved:true,image:'https://icons.duckduckgo.com/ip3/anthropic.com.ico'},
    ...
    {id:10,name:'DALL-E 3',emoji:'🖼️',cat:'image',pricing:'freemium',tagline:'OpenAI image generation via ChatGPT Plus.',votes:987,featured:false,url:'https://openai.com/dall-e-3',daysAgo:140,approved:true,image:'https://icons.duckduckgo.com/ip3/openai.com.ico'},
    ...
    {id:12,name:'Sora',emoji:'🎥',cat:'video',pricing:'freemium',tagline:"OpenAI's text-to-video AI model.",votes:2109,featured:true,url:'https://openai.com/sora',daysAgo:5,approved:true,image:'https://icons.duckduckgo.com/ip3/openai.com.ico'},
    ...
    {id:18,name:'Anthropic',emoji:'🧠',cat:'research',pricing:'freemium',tagline:'Advanced AI safety research and model development.',votes:543,featured:false,url:'https://anthropic.com',daysAgo:90,approved:true,image:'https://icons.duckduckgo.com/ip3/anthropic.com.ico'},
    ...
    {id:22,name:'Google Gemini',emoji:'✨',cat:'chat',pricing:'free',tagline:'Google\'s multimodal AI with 1M+ token context.',votes:2341,featured:false,url:'https://gemini.google.com',daysAgo:15,approved:true,image:'https://icons.duckduckgo.com/ip3/google.com.ico'},
